...
export const primitiveCatalogEntries = Object.freeze([
  ...
  definition({ id: "P23", name: "compounding", class: "financial_mechanics", stateful: true, randomness: "deterministic_or_stochastic", implementationStatus: "registered_only" }),
