...
import { Currency, DecimalAmount, Money, Percentage, Quantity, Rate, Ratio, RoundingPolicy, Unit } from "./values.js";
import { CURRENT_RUN_VERSIONS, type RunVersionMetadata } from "./version.js";
